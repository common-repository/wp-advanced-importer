...
function upload_method(){
    ...
    jQuery.ajax({
        ...
        success: function (uploaded_file_info) {
            ...
            if(uploaded_file_info == 'not support'){
                swal({
                                title: 'Invalid File Type',
                                text: "XML Parsing Error: File is not XML.",
                                type: "warning",
                                showCancelButton: false,
                                confirmButtonColor: "#DD6B55",
                                confirmButtonText: "Upload file again?",
...
jQuery(document).ready(function () {
    ...
    var pages = [];
    pages[1] = 'smack-uci-dashboard';
    pages[2] = 'smack-uci-import';
    pages[3] = 'smack-uci-managers';
    pages[4] = 'sm-uci-export';
    pages[5] = 'smack-uci-settings';
    pages[6] = 'smack-uci-support';
...
function igniteImport() {
    ...
    jQuery(window).unload(function(){
        var currentURL = location.protocol + '//' + location.host + location.pathname + '?page=smack-uci-import';
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            if(data['notification'] == 'Updated Successfully') {
                ...
                var currentURL = location.protocol + '//' + location.host + location.pathname + '?page=smack-uci-managers&step=templatemanager';
...
function show_updateTemplate(filename,id) {
    ...
    jQuery.ajax({
        ...
        success: function (data) {
            ...
            var currentURL = location.protocol + '//' + location.host + location.pathname + '?page=smack-uci-import&step=mapping_config&eventkey=' + event_data['eventkey'] + '&templateid=' + event_data['id'];
            window.location.assign(currentURL);
        },
        error: function (errorThrown) {
            console.log(errorThrown);
